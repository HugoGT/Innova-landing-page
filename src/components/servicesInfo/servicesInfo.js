...
export function ServicesInfo() {
  return (
    <>
      ...
      <div className="grid gap-4 p-6 max-w-7xl m-auto sm:grid-cols-2 md:grid-cols-3 md:pb-12">
        <div className="border border-gray-400 rounded-lg p-4">
          ...
          <p className="">
            ...
            sirven para llevar a cabo la edificación de cualquier construcción.
          </p>
        </div>
        <div className="border border-gray-400 rounded-lg p-4">
